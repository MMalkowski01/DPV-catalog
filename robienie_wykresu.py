...
maska_SMC = (d_SMC<5)
maska_MWB = (d_MWB<15)
plt.scatter(P_orb[maska_LMC],P_long[maska_LMC],c="firebrick",marker="v",label="LMC")  
plt.scatter(P_orb[maska_SMC],P_long[maska_SMC],c="navy",marker="P",label="SMC")
plt.scatter(P_orb[maska_MWB],P_long[maska_MWB],c="forestgreen",marker=".",label="bulge")
plt.xlabel("P orb[d]")
plt.ylabel("P long[d]")
plt.title("P-P plot")
